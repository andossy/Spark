...
# Define a new Flux called DRAIN
Flux("DRAIN", scale=307., shift=75.)

# The resulting analytic flux. The value u0 is skiped. The flux is computed
# on outer boundaries.
d_DRAIN = -scale*(u1-shift)
